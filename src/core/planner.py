...
class TravelPlanner :
    ...
    def create_itinerary(
        ...
        try:
            user_prompt = f"""Plan a {days}-day trip to {city}
            Interests: {', '.join(interests)}
            Travel Style: {style}
            Pace: {pace}
            Month: {month or 'Any'}
            
            Provide a detailed day-by-day itinerary including attractions, accommodations, 
            transportation options, and dining recommendations.
            """
